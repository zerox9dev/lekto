    ...
    <div className="min-h-screen bg-[var(--muted)]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-8 space-y-6">
        <div>
          ...
          <p className="text-sm text-[var(--muted-foreground)]">Student portal</p>
        </div>

        {/* Lessons */}
        <section className="space-y-3">
          <h2 className="text-lg font-semibold flex items-center gap-2"><BookOpen className="h-5 w-5" /> Lessons</h2>
          <div className="rounded-xl bg-white border p-6 text-center text-sm text-[var(--muted-foreground)]">
