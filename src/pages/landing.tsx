    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-24 pb-20">
        <div className="max-w-xl">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-zinc-100 text-[12px] font-medium text-zinc-500 mb-6">
            <Sparkles className="h-3 w-3" />
            Бесплатно для репетиторов
          </div>
          <h1 className="text-[42px] leading-[1.1] font-bold tracking-tight mb-5">
            Уроки и домашки
            <br />
            <span className="text-zinc-400">в одном месте</span>
          </h1>
          <p className="text-[17px] leading-relaxed text-zinc-500 mb-8 max-w-md">
            Создавайте уроки, назначайте интерактивные задания и делитесь ссылкой с учеником. Ему не нужно регистрироваться.
          </p>
          <Link
            to="/login"
            className="group inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-zinc-900 text-white text-[14px] font-medium hover:bg-zinc-800 transition-colors"
          >
            Начать бесплатно
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24">
        <div className="grid sm:grid-cols-2 gap-4">
          {features.map(({ icon: Icon, title, desc }) => (
            <div
              key={title}
              className="group rounded-2xl border border-zinc-100 p-6 hover:border-zinc-200 hover:bg-zinc-50/50 transition-all"
            >
              <div className="h-10 w-10 rounded-xl bg-zinc-100 flex items-center justify-center mb-4 group-hover:bg-zinc-200/70 transition-colors">
      ...
      <section className="border-t border-zinc-100">
        <div className="max-w-5xl mx-auto px-6 py-16 text-center">
          <h2 className="text-2xl font-bold mb-3">Попробуйте сейчас</h2>
          <p className="text-[15px] text-zinc-500 mb-6">Бесплатно. Без карты. Без ограничений.</p>
          <Link
            to="/login"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-zinc-900 text-white text-[14px] font-medium hover:bg-zinc-800 transition-colors"
          >
            Создать аккаунт
          </Link>
        </div>
      ...
      <footer className="border-t border-zinc-100 py-6">
        <div className="max-w-5xl mx-auto px-6 flex items-center justify-between text-[12px] text-zinc-400">
