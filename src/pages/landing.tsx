    ...
    <div className="min-h-screen bg-white">
      <header className="border-b">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-lg bg-[var(--primary)] flex items-center justify-center text-white font-bold text-sm">L</div>
            <span className="font-bold text-lg">Lekto</span>
          </div>
          <Link to="/login" className="text-sm font-medium text-[var(--primary)] hover:underline">Sign In</Link>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-6 py-20">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-[var(--muted-foreground)]">Create lessons, assign interactive homework, and share a simple link with your students. No student account needed.</p>
          <Link to="/login" className="inline-flex items-center justify-center mt-8 px-6 py-3 rounded-xl bg-[var(--primary)] text-white font-medium hover:opacity-90 transition-opacity">
            Get Started — Free
          </Link>
        </div>
      ...
      <footer className="border-t py-6 text-center text-xs text-[var(--muted-foreground)]">
